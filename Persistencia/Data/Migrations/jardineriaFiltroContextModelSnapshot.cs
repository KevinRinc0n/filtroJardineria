...
{
    [DbContext(typeof(jardineriaFiltroContext))]
    partial class jardineriaFiltroContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("Dominio.Entities.DetallePedido", b =>
                {
                    b.HasOne("Dominio.Entities.Pedido", "CodigoPedidoNavigation")
                        ...
                        .HasForeignKey("Dominio.Entities.DetallePedido", "CodigoPedido")
                        .IsRequired()
